...
<code>
    <?php 
        echo '
            $title = "Bom pra vender";<br/>
            $msg   = "Sempre te acham"; <br/>
            $link  = "Será que é bom?";<br/><br/>

            //carrega o plugin<br/>
            $this->Js->LoadPlugin("dialog", "jqueryui", "juiplug");<br/>
            $this->Js->juiplug->draw($title, $msg, $link);<br/>
            $this->Js->juiplug->draw($title, $msg, $link);<br/>';
    ?>
</code>
...
<?php
    ...
    $link  = "Será que é bom?";
    $this->Js->LoadPlugin("dialog", "jqueryui", "juiplug");
    $this->Js->juiplug->draw($title, $msg, $link);
    $this->Js->juiplug->draw("it Works", "Woooaahh!!", "omg");
?>